...
DEVS = list(map(int, os.getenv("DEVS", "8393020548").split()))

API_ID = int(os.getenv("API_ID", "22564691"))

API_HASH = os.getenv("API_HASH", "e3a9fb11b93effccba295086169acefb")

BOT_TOKEN = os.getenv("BOT_TOKEN", "8755683502:AAGX2kMfN_ICRxUm_kheszOIgFZSPW4dc5U")

OWNER_ID = int(os.getenv("OWNER_ID", "8393020548"))
